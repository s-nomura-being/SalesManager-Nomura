...
{
    public class TotalSalesViewFileManager
    {
        ...
        public TotalSalesViewFileManager(IFileProcessor fileprocesser)
        {
        ...
        public bool ReadFile(string filePath, out List<TotalSalesData> data)
        {
        ...
        public bool SaveFile(List<TotalSalesData> data)
        {
        ...
        /// <param name="data">保存するデータのリスト</param>
        /// <returns>保存に成功したかどうか</returns>
        public bool SaveFile(string path, List<TotalSalesData> data)
        {
