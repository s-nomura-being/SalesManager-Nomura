...
{
    public class DetailSalesViewFileManager
    {
        ...
        public DetailSalesViewFileManager(IFileProcessor fileprocesser)
        {
        ...
        public bool ReadFile(string filePath, out List<DetailSalesData> data)
        {
        ...
        public bool SaveFile(List<DetailSalesData> data)
        {
        ...
        /// <param name="data">保存するデータのリスト</param>
        /// <returns>保存に成功したかどうか</returns>
        public bool SaveFile(string path, List<DetailSalesData> data)
        {
