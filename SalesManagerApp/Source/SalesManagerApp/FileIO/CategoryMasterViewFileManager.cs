...
{
    public class CategoryMasterViewFileManager
    {
        private readonly IFileProcessor _fileprocesser;

        /// <summary>保存ファイル名</summary>
        private const string SAVE_FILENAME = "master/区分マスタ";
        ...
        public CategoryMasterViewFileManager(IFileProcessor fileprocesser)
        {
        ...
        public bool ReadFile(string filePath, out List<CategoryMasterData> data)
        {
