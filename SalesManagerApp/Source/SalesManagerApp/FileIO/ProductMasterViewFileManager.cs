...
{
    public class ProductMasterViewFileManager
    {
        private readonly IFileProcessor _fileprocesser;

        /// <summary>保存ファイル名</summary>
        private const string SAVE_FILENAME = "master/商品マスタ";
        ...
        public ProductMasterViewFileManager(IFileProcessor fileprocesser)
        {
        ...
        public bool ReadFile(string filePath, out List<ProductMasterData> data)
        {
        ...
        public bool SaveFile(List<ProductMasterData> data)
        {
