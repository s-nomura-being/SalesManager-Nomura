...
{
    public class InventoryInfoViewFileManager
    {
        ...
        public InventoryInfoViewFileManager(IFileProcessor fileprocesser)
        {
        ...
        public bool ReadFile(string filePath, out List<InventoryListData> data)
        {
        ...
        public bool SaveFile(List<InventoryListData> data)
        {
        ...
        /// ファイルを保存する
        /// </summary>
        /// <param name="path">保存先のフォルダパス</param>
        /// <param name="data">保存するデータのリスト</param>
        /// <returns>保存に成功したかどうか</returns>
        public bool SaveFile(string path, List<InventoryListData> data)
        {
            return _fileprocesser.SaveFile(path, data);
        }
    }
}
